...
let mesDeDiferenca = dataAtual.diff(dataAntiga, 'month');


// console.log("A diferenca de dias entre 15/09/2005 e 15/09/2020 é " +diasDeDiferenca+" dias.");
// console.log("A diferenca de meses entre 15/09/2005 e 15/09/2020 é " +mesDeDiferenca+" meses.");
...
console.log("A diferenca de dias entre 15/09/2005 e 15/09/2020 é " +mesesDeDiferencaFNS+" dias.")